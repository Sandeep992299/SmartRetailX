        ...
        try:
            if db.products.count_documents({}) == 0:
                ...
                sample_products = [
                    ...
                    {"name": "Sony Ultra-Clear 4K OLED Smart TV", "description": "Vivid color HDR, 120Hz refresh rate, Dolby Atmos spatial audio.", "price": 899.00, "category": "Electronics", "image_url": "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=800&q=80"},
                    {"name": "MacBook Pro M3 Aluminum Laptop", "description": "Blazing fast 12-core CPU, Liquid Retina XDR display, 22h battery life.", "price": 1499.00, "category": "Electronics", "image_url": "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Studio Professional DSLR Camera", "description": "45MP full-frame sensor with 8K RAW video and dual image stabilization.", "price": 649.00, "category": "Electronics", "image_url": "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Wireless Bluetooth Stereo Soundbar", "description": "Deep bass subwoofer with optical and HDMI eARC connectivity.", "price": 129.99, "category": "Electronics", "image_url": "https://images.unsplash.com/photo-1545454675-3531b543be5d?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Smart Home AI Security Camera 360", "description": "Night vision 2K recording with AI human motion tracking and two-way audio.", "price": 59.50, "category": "Electronics", "image_url": "https://images.unsplash.com/photo-1557324232-b8917d3c3dcb?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Scandinavian Solid Oak Dining Table", "description": "Crafted from sustainable European white oak with durable matte oil finish.", "price": 480.00, "category": "Furniture", "image_url": "https://images.unsplash.com/photo-1530018607912-eff2daa1bac4?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Velvet Luxury Accent Armchair", "description": "Plush emerald velvet upholstery with gold-plated tapered steel legs.", "price": 320.00, "category": "Furniture", "image_url": "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Minimalist Walnut Bookshelf", "description": "5-tier open architecture shelving unit with reinforced structural steel brackets.", "price": 175.00, "category": "Furniture", "image_url": "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Modern Arc Floor Reading Lamp", "description": "Dimmable warm ambient LED lighting with heavy marble stability base.", "price": 89.00, "category": "Furniture", "image_url": "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Memory Foam King Platform Bed", "description": "Zero-motion transfer cooling gel memory mattress with upholstered headboard.", "price": 550.00, "category": "Furniture", "image_url": "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Ultralight 4-Person Waterproof Camping Tent", "description": "Ripstop silicone-coated nylon, wind tested up to 45 mph, quick 3-min setup.", "price": 189.99, "category": "Outdoor", "image_url": "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=800&q=80"},
                    {"name": "All-Terrain Mountain Trail Bike", "description": "Hydraulic disc brakes, Shimano 21-speed gear train, lightweight alloy frame.", "price": 499.00, "category": "Outdoor", "image_url": "https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Solar Powered 20000mAh Power Bank", "description": "Dual QC 3.0 outputs with integrated LED emergency floodlight and compass.", "price": 45.00, "category": "Outdoor", "image_url": "https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Thermal Insulated Expedition Backpack 50L", "description": "Ergonomic lumbar suspension harness with integrated hydration bladder port.", "price": 115.00, "category": "Outdoor", "image_url": "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Portable Stainless Steel Camping Stove", "description": "Ultracompact piezo-ignition burner with wind baffle and brass valve.", "price": 38.50, "category": "Outdoor", "image_url": "https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Classic Tailored Wool Trench Coat", "description": "100% Merino wool exterior with water-repellent finish and silk lining.", "price": 210.00, "category": "Apparel", "image_url": "https://images.unsplash.com/photo-1539533018447-63fcce667883?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Polarized Aviator Titanium Sunglasses", "description": "UV400 scratch-resistant polarized lenses with flexible titanium alloy frame.", "price": 75.00, "category": "Apparel", "image_url": "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Breathable Aerodynamic Running Sneakers", "description": "Responsive carbon plate propulsion sole with breathable engineered mesh.", "price": 130.00, "category": "Apparel", "image_url": "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Waterproof Chronograph Sapphire Watch", "description": "Automatic mechanical movement, 100m water resistance, sapphire crystal glass.", "price": 285.00, "category": "Apparel", "image_url": "https://images.unsplash.com/photo-1524805444758-089113d48a6d?auto=format&fit=crop&w=800&q=80"},
                    {"name": "Handcrafted Full-Grain Leather Duffel Bag", "description": "Vegetable-tanned artisanal cowhide with heavy brass hardware and shoe pocket.", "price": 165.00, "category": "Apparel", "image_url": "https://images.unsplash.com/photo-1547949003-9792a18a2601?auto=format&fit=crop&w=800&q=80"}
                ]
                db.products.insert_many(sample_products)
                print("MongoDB database seeded with sample products containing AWS S3 & CDN asset references.")
        except Exception as e:
